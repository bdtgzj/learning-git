...
var getAggregate = function(condition) {
  return [
    ...
    { $project: { name: 1, password: 1, nickName: 1, email: 1, mphone: 1, state: 1, familyId: 1, created:1, familyName: "$family_docs.name", fid: "$family_docs.fid" } }
  ]
};
...
exports.getUserByIdPass = function(id, password, callback) {
  User.findOne({_id: id, password: password}, callback);
};
